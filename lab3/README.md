    ...
    API дозволяє створювати, переглядати, оновлювати та видаляти гравців, ресурси та матчі, а також фільтрувати їх.
    Для зберігання даних використовується база даних PostgreSQL.
    ...
    - Uvicorn - ASGI сервер
    - SQLAlchemy + AsyncIO - робота з базою даних
    - PostgreSQL - реляційна база даних для зберігання гравців, ресурсів та матчів
    ...
    5. Налаштуйте базу даних PostgreSQL (локально або через Docker):
    ```# Через Docker
    docker run --name game-postgres -e POSTGRES_PASSWORD=postgres -e POSTGRES_DB=game -p 5432:5432 -d postgres:15
    ```
